...
This capability defines the Multi-Factor Authentication (MFA) configuration system for both production and UITest modes. It manages TOTP secret retrieval, verification, and user MFA enablement, with special support for automated testing via the `MFAConfigManagerForUAT` singleton.
...
### Automatic TOTP display for UITest
**Deprecated in**: 2025-02-04
...
### MFAConfigManagerForUAT published verifyCode property
**Deprecated in**: 2025-02-04
