# viewtab-treeview-integration Specification

## Purpose
Integration layer for rendering View Tab's site/device list using the TreeView component, including the ViewTabItem data model, flat list construction logic for grid/list modes, and search integration.
