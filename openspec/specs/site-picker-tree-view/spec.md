...
Reusable generic TreeView component for rendering hierarchical data with expand/collapse support, using a flattened single-LazyVStack architecture to avoid nested lazy container crashes at scale.
