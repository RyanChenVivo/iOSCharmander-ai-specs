...
This capability provides MFA testing utilities for UITest mode, enabling automated tests to set up MFA and retrieve TOTP codes via a clipboard-based approach. This replaces the previous automatic TOTP display mechanism which had timing stability issues.
