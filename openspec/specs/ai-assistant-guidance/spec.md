...
## Purpose
Defines requirements for AI assistant guidance tools that help developers implement Vortex features consistently. This includes Claude Code skills that provide project conventions, architecture patterns, coding standards, and best practices in a context-aware manner.
## Requirements
